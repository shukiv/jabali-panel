...
return [
    ...
    */
    ...
    // Mounted under /jabali-admin so operators reach it from the admin panel
    // and so auth:admin can guard it via our gate callback (see AppServiceProvider).
    'route_path' => 'jabali-admin/log-viewer',
