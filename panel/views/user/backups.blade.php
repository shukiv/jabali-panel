    ...
    <div class="fi-sc-tabs">
        ...
        <x-tab-loading-skeleton>
            ...
            <x-filament::section :heading="__('Restore Snapshot')" :description="__('Snapshot :id', ['id' => $restoreSnapshotId])" icon="heroicon-o-arrow-path">
                <label><input type="checkbox" wire:model.live="restoreFiles"> {{ __('Files') }}</label>
                <label><input type="checkbox" wire:model.live="restoreDatabases"> {{ __('Databases') }}</label>
                <label><input type="checkbox" wire:model.live="restoreMailboxes"> {{ __('Email') }}</label>
                <br>
                <label><input type="checkbox" wire:model.live="restoreForce"> {{ __('Overwrite existing data') }}</label>
