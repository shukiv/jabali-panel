<x-filament-widgets::widget>
    <x-filament::section>
        ...
        <div
            ...
            x-init="init()"
        >
            <div style="position: relative; height: 50px"><canvas id="usage-disk-chart"></canvas></div>
            <div style="position: relative; height: 50px; margin-top: 8px"><canvas id="usage-bw-chart"></canvas></div>
